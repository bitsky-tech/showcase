...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Bridgic Showcase","description":"Workflow showcase and data API for bridgic clients","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":{"light":"/assets/logo.svg","dark":"/assets/logo_dark.svg"},"siteTitle":false,"socialLinks":[{"icon":"github","link":"https://github.com/bitsky-tech/showcase"}],"search":{"provider":"local"}},"locales":{"zh":{"label":"简体中文","lang":"zh-Hans","title":"Bridgic 工作流展示","description":"面向 bridgic 客户端的工作流展示与数据接口","themeConfig":{"nav":[{"text":"首页","link":"/zh/"},{"text":"工作流","link":"/zh/workflows/"},{"text":"接口","link":"/zh/api"}],"sidebar":{"/zh/workflows/":[{"text":"工作流","items":[{"text":"全部工作流","link":"/zh/workflows/"},{"text":"小红书内容爬虫","link":"/zh/workflows/xiaohongshu"},{"text":"飞书日报生成器","link":"/zh/workflows/feishu-daily"},{"text":"竞品价格监控","link":"/zh/workflows/price-monitor"},{"text":"GitHub Issue 分析","link":"/zh/workflows/github-issues"},{"text":"PDF 批量提取器","link":"/zh/workflows/pdf-extract"},{"text":"邮件自动回复","link":"/zh/workflows/mail-reply"}]}]},"outline":{"level":[2,3],"label":"本页目录"},"docFooter":{"prev":"上一页","next":"下一页"},"lastUpdatedText":"最后更新","returnToTopLabel":"回到顶部","sidebarMenuLabel":"菜单","darkModeSwitchLabel":"主题","lightModeSwitchTitle":"切换到浅色模式","darkModeSwitchTitle":"切换到深色模式","langMenuLabel":"切换语言"}},"en":{"label":"English","lang":"en-US","title":"Bridgic Showcase","description":"Workflow showcase and data API for bridgic clients","themeConfig":{"nav":[{"text":"Home","link":"/en/"},{"text":"Workflows","link":"/en/workflows/"},{"text":"API","link":"/en/api"}],"sidebar":{"/en/workflows/":[{"text":"Workflows","items":[{"text":"All workflows","link":"/en/workflows/"},{"text":"Xiaohongshu content scraper","link":"/en/workflows/xiaohongshu"},{"text":"Feishu daily report generator","link":"/en/workflows/feishu-daily"},{"text":"Competitor price monitor","link":"/en/workflows/price-monitor"},{"text":"GitHub Issue analysis","link":"/en/workflows/github-issues"},{"text":"PDF batch extractor","link":"/en/workflows/pdf-extract"},{"text":"Automatic email replies","link":"/en/workflows/mail-reply"}]}]},"outline":{"level":[2,3]}}}},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$18 = {
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      ...
      let settings = await import("./virtual_mermaid-config.BVgdb3Xy.js");
...
const _sfc_main$v = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.CF9rapEb.js"));
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const src = props.bvid ? `https://player.bilibili.com/player.html?bvid=${props.bvid}&autoplay=0` : `https://www.youtube-nocookie.com/embed/${props.yt}`;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "embed-video" }, _attrs))} data-v-b11b40ff>`);
      if (mounted.value) {
        _push(`<iframe${ssrRenderAttr("src", unref(src))} loading="lazy" allow="fullscreen; picture-in-picture; encrypted-media" allowfullscreen data-v-b11b40ff></iframe>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/EmbedVideo.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const EmbedVideo = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-b11b40ff"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lang-switch" }, _attrs))} data-v-2f0a7d3d><!--[-->`);
      ssrRenderList(langs, (l, i) => {
        _push(`<!--[-->`);
        if (i > 0) {
          _push(`<span class="sep" aria-hidden="true" data-v-2f0a7d3d>/</span>`);
        } else {
          _push(`<!---->`);
        }
        if (l.code === "zh" === isZh.value) {
          _push(`<span class="lang current" aria-current="true" data-v-2f0a7d3d>${ssrInterpolate(l.label)}</span>`);
        } else {
          _push(`<a class="lang"${ssrRenderAttr("href", hrefFor(l.code))} data-v-2f0a7d3d>${ssrInterpolate(l.label)}</a>`);
        }
        _push(`<!--]-->`);
      });
      _push(`<!--]--></div>`);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/LangSwitch.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const LangSwitch = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-2f0a7d3d"]]);
const workflows$1 = [
  {
    id: "project-management-automation",
    name: "Feishu Bitable project management tutorial",
    desc: "A practical example of automating software project management with Feishu Bitable: agents can report bugs, scheduled runs can scan and analyze them, and sub-agents can be split out automatically.",
    domain: "IT systems integration",
    status: "verified",
    path: "en/workflows/project-management-automation",
    goal: "Automate and streamline long-running project-management work",
    requirement: "A Feishu account and an application created in the Feishu Open Platform",
    output: "Task records stored in Feishu Bitable and a bug analysis report"
  },
  {
    id: "e-commerce-product-scraper",
    name: "Tmall Supermarket product scraper tutorial",
    desc: "Demonstrates how to scrape product information from a Tmall Supermarket category and automatically download product images.",
    domain: "Browser automation",
    status: "verified",
    path: "en/workflows/e-commerce-product-scraper",
    goal: "Automatically retrieve product information for a specified Tmall Supermarket search term",
    requirement: "A Tmall Supermarket account for signing in",
    output: "An Excel spreadsheet containing product information"
  },
  {
    id: "priceMonitor",
    ...
    goal: "Notice a competitor price change as soon as it happens",
    requirement: "A list of product URLs; a price selector where the markup is unusual",
    output: "Alerts past the threshold, plus snapshots that keep the trend auditable"
  },
  {
    id: "githubIssues",
    name: "GitHub Issue analysis",
    desc: "Analyze repository Issue trends and produce a weekly report",
    domain: "API integration",
    status: "new",
    path: "en/workflows/github-issues",
    goal: "See where the week’s problems cluster and which class is spiking",
    requirement: "A list of repositories; a GitHub token with read access",
    output: "A weekly report with opened/closed/stale counts and trend outliers"
  },
  {
    id: "pdfExtract",
    name: "PDF batch extractor",
    desc: "Extract structured data from multiple PDFs into Excel",
    domain: "File processing",
    status: "verified",
    path: "en/workflows/pdf-extract",
    goal: "Turn a batch of fixed-layout documents into a table you can analyse",
    requirement: "An input directory; a field template of keyword anchors and offsets",
    output: "One Excel row per document, with failed validations flagged for review"
  },
  {
    id: "mailReply",
    name: "Automatic email replies",
    desc: "Automatically classify and reply to common emails based on rules",
    domain: "Email integration",
    status: "new",
    path: "en/workflows/mail-reply",
    goal: "Stop repetitive email questions from consuming human time",
    requirement: "An intent-to-template mapping; sender domains cleared for auto-send",
    output: "A sent reply or a draft awaiting review, with the decision recorded"
  }
];
const en = {
...
const workflows = [
  {
    id: "project-management-automation",
    name: "飞书表格项目管理教程",
    desc: "演示基于飞书多维表格自动化管理“软件项目”的一个案例，可以通过agent上报bug，也支持自动扫描分析bug。还演示了自动拆分子agent的能力。",
    domain: "IT系统集成",
    status: "verified",
    path: "zh/workflows/project-management-automation",
    goal: "项目管理长任务自动化、提效",
    requirement: "有飞书账号；在飞书开放平台创建应用",
    output: "飞书表格保存任务记录；产出Bug分析报告"
  },
  {
    id: "e-commerce-product-scraper",
    name: "天猫超市商品抓取教程",
    desc: "演示从天猫超市抓取某一类商品信息并自动化下载商品图片",
    domain: "浏览器自动化",
    status: "verified",
    path: "zh/workflows/e-commerce-product-scraper",
    goal: "自动化抓取天猫超市上指定搜索词的商品信息",
    requirement: "需要登录天猫超市账号",
    output: "生成包含商品信息的excel表格"
  },
  {
    id: "priceMonitor",
    name: "竞品价格监控",
    ...
    goal: "在竞品调价时第一时间发现并告警",
    requirement: "商品页地址列表；页面结构特殊时需指定价格选择器",
    output: "超过阈值的变动告警，以及可回溯趋势的历史快照"
  },
  {
    id: "githubIssues",
    name: "GitHub Issue 分析",
    desc: "自动分析仓库 Issue 趋势，生成周报",
    domain: "API 集成",
    status: "new",
    path: "zh/workflows/github-issues",
    goal: "看清一周内的问题集中在哪些方向、哪类在放量",
    requirement: "仓库列表；具备读取权限的 GitHub token",
    output: "含新增/关闭/停滞数与趋势异常的周报"
  },
  {
    id: "pdfExtract",
    name: "PDF 批量提取器",
    desc: "从多个 PDF 中提取结构化数据到 Excel",
    domain: "文件处理",
    status: "verified",
    path: "zh/workflows/pdf-extract",
    goal: "把版式相对固定的批量文档转成可直接分析的表格",
    requirement: "输入目录；由关键字锚点与相对位置构成的字段模板",
    output: "一行一文档的 Excel，校验失败的行单独标记待复核"
  },
  {
    id: "mailReply",
    name: "邮件自动回复",
    desc: "根据规则自动分类和回复常见邮件",
    domain: "邮件集成",
    status: "new",
    path: "zh/workflows/mail-reply",
    goal: "让问法重复的邮件不再占用人工时间",
    requirement: "意图与模板的映射；允许自动发送的发件域名单",
    output: "自动发送的回复或待确认草稿，并留下处置记录"
  }
];
const zh = {
  workflows
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isZh = computed(() => lang.value.startsWith("zh"));
    const workflows2 = computed(() => (isZh.value ? zh : en).workflows);
    const copy = computed(
      () => isZh.value ? { verified: "已验证", fresh: "新增", view: "查看详情" } : { verified: "Verified", fresh: "New", view: "View details" }
    );
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "wf-grid" }, _attrs))} data-v-679d5894><!--[-->`);
      ssrRenderList(workflows2.value, (w) => {
        _push(`<a class="wf-card"${ssrRenderAttr("href", unref(withBase)(`/${w.path}`))} data-v-679d5894><div class="wf-head" data-v-679d5894><span class="wf-icon" aria-hidden="true" data-v-679d5894><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-679d5894><rect x="3" y="3" width="6" height="6" rx="1.5" data-v-679d5894></rect><rect x="15" y="15" width="6" height="6" rx="1.5" data-v-679d5894></rect><path d="M9 6h4a2 2 0 0 1 2 2v10" data-v-679d5894></path></svg></span>`);
        if (w.status === "verified") {
          _push(`<span class="wf-badge wf-badge--ok" data-v-679d5894>${ssrInterpolate(copy.value.verified)}</span>`);
        } else {
          _push(`<span class="wf-badge wf-badge--new" data-v-679d5894>${ssrInterpolate(copy.value.fresh)}</span>`);
        }
        _push(`</div><div class="wf-name" data-v-679d5894>${ssrInterpolate(w.name)}</div><div class="wf-desc" data-v-679d5894>${ssrInterpolate(w.desc)}</div><div class="wf-foot" data-v-679d5894><span class="wf-tag" data-v-679d5894>${ssrInterpolate(w.domain)}</span><span class="wf-view" data-v-679d5894>${ssrInterpolate(copy.value.view)} →</span></div></a>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/WorkflowGrid.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const WorkflowGrid = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-679d5894"]]);
const RawTheme = {
  extends: theme,
  Layout() {
...
async function createApp() {
  ...
  app.component("Mermaid", _sfc_main$18);
